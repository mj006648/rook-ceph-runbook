...
| --- | --- | --- | --- |
| 2026-09-10 | Ceph / PG placement | [TwinX Ceph 내부 풀 배치 복구](twinx-ceph-internal-pool-placement-recovery-2026-09-10.md) | 같은 NVMe의 논리 OSD, 대상 65 PG 복구·추가 32 PG 미해결, 삭제 방지 |
