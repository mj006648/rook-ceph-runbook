...
| --- | --- | --- | --- |
| 2026-09-10 | Storage | 단일 SSD Ceph 대상 65 PG 복구, 추가 내부 풀 32 PG inactive 후속 점검 | [TwinX Ceph 내부 풀 배치 복구](storage/twinx-ceph-internal-pool-placement-recovery-2026-09-10.md) |
