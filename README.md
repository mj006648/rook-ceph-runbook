...
| --- | --- | --- | --- |
| 2026-09-10 | Kubernetes / Storage | [TwinX Ceph 내부 풀 배치 복구](kubernetes/storage/twinx-ceph-internal-pool-placement-recovery-2026-09-10.md) | 대상 65 PG 복구, 추가 내부 풀 32 PG 예외, 단일 SSD 제약·검증·삭제 방지 |
