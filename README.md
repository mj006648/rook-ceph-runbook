...
| --- | --- | --- | --- |
| 2026-09-10 | Kubernetes / Storage | [TwinX Ceph 내부 풀 배치 복구](kubernetes/storage/twinx-ceph-internal-pool-placement-recovery-2026-09-10.md) | 단일 SSD 제약, 65 PG inactive 원인, 수동 GitOps 복구 준비·Sync 대기, 검증·삭제 방지 |
